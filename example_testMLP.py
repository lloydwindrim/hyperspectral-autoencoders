...
# setup network
net = autoencoder.mlp_1D_network( configFile='models/test_model/config.json' ) #inputSize=hypData.numBands, activationFunc='relu',tiedWeights=None, skipConnect=False
